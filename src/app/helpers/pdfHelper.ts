...
export class PdfHelperService {
  ...
  private setupTurkishFont(doc: jsPDF): void {
    ...
    doc.addFont('assets/fonts/roboto/Roboto-BoldItalic.ttf', 'Roboto', 'bolditalic');

    // Unicode desteğini etkinleştirin
    doc.setFont('Roboto', 'normal');
    doc.addFileToVFS('Roboto-Regular.ttf', 'assets/fonts/roboto/Roboto-Regular.ttf');
  } catch (error) {
   ...
   * Tablo verilerini hazırla
   */
  private prepareTableData<T>(data: T[], columns: TableColumn[]): string[][] {
